export const recapText = {
  ...
  positions: [
    ...
    },
    {
      day: "Day Two",
      title: "DiscoverIT",
      desc: "DiscoverIT gives competitors the opportunity to explore Vancouver alongside their Team Hosts. Competitors captured memories in 3 of Vancouver’s iconic landmarks: Vancouver Aquarium, Capilano Suspension Bridge, and Flyover Canada!",
      title2: "Welcoming Ceremony ",
      desc2:
        "The Welcome Ceremony celebrates, brings together, and connects competing teams, coaches, industry professionals, and the CaseIT Organizing Committee for the very first time, jumpstarting the official start to CaseIT 2024.",
    ...
    },
    {
      ...
      desc2: "As our competitors were challenged with the 24-hour case, the coaches were invited to an exclusive dinner for their diligent efforts in the heart of downtown Vancouver. The dinner offered a chance for coaches to unwind, share experiences, and celebrate the hard work and dedication that went into guiding the teams throughout the intense competition.",
    ...
    },
    {
      ...
      desc: "Case II brings the thrill for competitors to present their findings to a panel of industry professionals after an intense 24-hour deliberation period. A Wildcard round then occurs, where chosen teams are given an opportunity to get a spot in the Finals round. First runners of the Preliminary round and the Wildcard round winner advance to the Final round to compete for podium placements in the renowned CaseIT international undergraduate case competition!",
      title2: "Award Banquet",
      desc2: "The Awards Banquet wrapped up our intensive competition week of CaseIT 2024. Competitors gathered in formal attire to celebrate their achievements. The evening featured speeches from faculty members and the CaseIT team, highlighting the event's significance and the hard work of all participants. Finally, the winners of CaseIT 2024 were announced along with other exiting awards.",
