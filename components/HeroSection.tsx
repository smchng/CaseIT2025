...
import hero3 from "@/public/imgs/hero/hero3.jpg";
  ...
  return (
    <section className="flex w-full h-full">
      ...
      <div className="hidden md:grid grid-cols-[repeat(50,_2%)] grid-rows-[repeat(50,_2%)] w-full h-screen opacity-30 grayscale">
        ...
        >
          <Image src={hero1} alt="something" className="h-full object-cover " />
        </div>
        <div
        ...
        >
          <Image src={hero2} alt="something" className="h-full object-cover " />
        </div>
        ...
        >
          <Image src={hero4} alt="something" className="h-full object-cover " />
        </div>

        <div
          className=" rounded-xl overflow-hidden  bg-buttonBlack transition-transform duration-300 ease-out col-start-[18] col-[8_/_span_14] row-start-[3] row-[18_/_span_18]"
          style={{
            transform: `translate(${offset.x}px, ${offset.y}px)`,
          }}
        >
          <Image src={hero3} alt="something" className="h-full object-cover " />
        </div>
        ...
        >
          <Image src={hero5} alt="something" className="h-full object-cover " />
        </div>
        ...
        >
          <Image src={hero6} alt="something" className="h-full object-cover " />
        </div>
      </div>
    </section>
  );
